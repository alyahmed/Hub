$(document).ready(function(){
	$("form#main_input_box").submit(function(event){
		...
		$(".list_of_items").append("<div class='todolist_list showactions'>  " + "<div class='col-md-8 col-sm-8 col-xs-8 nopadmar custom_textbox1'> <div class='todoitemcheck'>" + checkBox +"</div>" + "<div class='todotext todoitemjs'>" + $("#custom_textbox").val() + "</div> </div>" +  twoButtons );
		$("#custom_textbox").val('');
	});
